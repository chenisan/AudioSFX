          ...
          <div className="relative" ref={menuRef}>
            ...
            {showMenu && (
              <>
                ...
                <div className="absolute left-0 bottom-full mb-1 bg-[#2a2a2a] border border-[#444] rounded-lg shadow-xl z-50 py-1 min-w-[130px]">
                  {/* Track height */}
                  <div
                    className="relative"
                    onMouseEnter={() => setSubMenu('height')}
                    onMouseLeave={() => setSubMenu(null)}
                  >
                    <button className="w-full flex items-center justify-between px-3 py-1.5 text-xs text-[#ccc] hover:bg-[#3a3a3a]">
                      <span>資料軌高度</span>
                  ...
                  {track.type === 'audio' && (
                    <div
                      className="relative"
                      onMouseEnter={() => setSubMenu('waveform')}
                      onMouseLeave={() => setSubMenu(null)}
                    >
                      <button className="w-full flex items-center justify-between px-3 py-1.5 text-xs text-[#ccc] hover:bg-[#3a3a3a]">
                        <span>音訊波形大小</span>
